        ...
        <table class="pr-form__input-container">
            ...
            <tr class="pr-form__field radio-field field_mandatory">
                <td colspan="2">
                    ...
                    <table>
                        <tr>
                            <td><input type="radio" name="pr-type" id="triangle-perimeter"
                                       value="triangle-perimeter"><label for="triangle-perimeter">Периметр
                                    треугольника</label></td>

                            <td><input type="radio" name="pr-type" id="arith-average" value="arith-average"><label
                                        for="arith-average">Среднее арифметическое</label></td>
                        </tr>
                        <tr>
                            <td><input type="radio" name="pr-type" id="triangle-square" value="triangle-square" checked><label
                                        for="triangle-square">Площадь треугольника</label></td>
                            <td><input type="radio" name="pr-type" id="geom-average" value="geom-average"><label
                                        for="geom-average">Среднее геометрическое</label></td>
                        </tr>
                        <tr>
                            <td><input type="radio" name="pr-type" id="prlppd-volume" value="prlppd-volume"><label
                                        for="prlppd-volume">Объем параллелепипеда</label></td>
                            <td><input type="radio" name="pr-type" id="bitwise-conjunction" value="bitwise-conjunction"><label
                                        for="bitwise-conjunction">Побитовая конъюнкиция</label></td>
                        </tr>
                    </table>
            ...
            <tr class="pr-form__field radio-field field_mandatory">
                <td colspan="2">
                    ...
                    <table>
                        <tr>
                            <td><input type="radio" name="view-type" id="browser-view" value="browser-view"
                                       checked><label for="browser-view">Для браузера</label></td>
                            <td><input type="radio" name="view-type" id="print-view" value="print-view"><label
                                        for="print-view">Для печати</label></td>
                        </tr>
                    </table>
